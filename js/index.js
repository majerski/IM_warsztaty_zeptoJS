    ...
    onDeviceReady: function() {
		...
		function renderArtykuly(){
			...
			if(artykuly_loaded) {
				...
				artykulyDiv.innerHTML = '<div class="articles_pagination"><a href="#" class="first" data-action="first">&laquo;</a><a href="#" class="previous" data-action="previous">&lsaquo;</a><input type="text" readonly="readonly" data-max-page="40" /><a href="#" class="next" data-action="next">&rsaquo;</a><a href="#" class="last" data-action="last">&raquo;</a></div><ul>'+list.innerHTML+'</ul>';
